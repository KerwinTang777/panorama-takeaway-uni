<template>
	<view style="padding: 40rpx;">
		<view style="padding: 20rpx; margin: 80rpx 0; background-color: #fff; box-shadow: 0 2rpx 10rpx rgba(0,0,0,.1); border-radius: 10rpx;">
			<view style="margin: 50rpx 30rpx; font-size: 50rpx; color: #F85D4C;">Paranoma</view>
			<uni-forms ref="form" :modelValue="form" :rules="rules" validateTrigger='blur'>
				...
				<uni-forms-item>
					<button @click="login()" 
						style="background-color: #F85D4C; 
							   border-color: #F85D4C; 
							   height: 70rpx;
							   line-height:70rpx; 
							   color: #fff;">登 录</button>
				</uni-forms-item>
				<uni-forms-item>
					<view style="text-align: right;">还没有账号？去 
						<navigator style="display: inline-block; color: dodgerblue; 
							margin-left: 4rpx;" url="/pages/register/register">
						注册</navigator>
					</view>
				</uni-forms-item>
			</uni-forms>
